...
[![Sélection de certificats, identificateurs & profils](certificates-identifiers-images/devcenter02.png "Sélection de certificats, identificateurs & profils")](certificates-identifiers-images/devcenter02-large.png#lightbox)

Cliquez ensuite sur le **lien Certificates** sous la section **Mac Apps** :

[![Sélection du lien certificats](certificates-identifiers-images/devcenter03.png "Sélection du lien certificats")](certificates-identifiers-images/devcenter03-large.png#lightbox)
...
1. Entrez une valeur **App ID Description** et sélectionnez les **App Services** dont l’application a besoin :
    ...
    [![Saisie de la description et des services d’application](certificates-identifiers-images/devcenter04.png "Saisie de la description et des services d’application")](certificates-identifiers-images/devcenter04-large.png#lightbox)
2. Entrez une valeur **Bundle ID** pour l’application, puis cliquez sur le bouton **Continue** :

    [![Saisie d’un ID de Bundle](certificates-identifiers-images/devcenter05.png "Saisie d’un ID de Bundle")](certificates-identifiers-images/devcenter05-large.png#lightbox)
...
[![Modification du nouvel ID d’application](certificates-identifiers-images/devcenter07.png "Modification du nouvel ID d’application")](certificates-identifiers-images/devcenter07-large.png#lightbox)
...
[![Saisie des informations relatives au nouvel ordinateur](certificates-identifiers-images/devcenter11.png "Saisie des informations relatives au nouvel ordinateur")](certificates-identifiers-images/devcenter11-large.png#lightbox)
...
[![Création d’un nouveau certificat](certificates-identifiers-images/certif01.png "Création d’un nouveau certificat")](certificates-identifiers-images/certif01-large.png#lightbox)
...
2. L’écran suivant explique comment utiliser un accès au trousseau pour créer un fichier de demande de signature de certificat à charger :
    ...
    [![Écran de chargement de l’accès au trousseau](certificates-identifiers-images/certif03.png "Écran de chargement de l’accès au trousseau")](certificates-identifiers-images/certif03-large.png#lightbox)
...
4. Un fichier de demande de certificat (extension `.certSigningRequest`) est enregistré localement sur le Mac. Rappelez-vous où il est enregistré (l’emplacement par défaut est le bureau), car il doit être choisi à la prochaine étape :
    ...
    [![Téléchargement du fichier de certificat](certificates-identifiers-images/image13.png "Téléchargement du fichier de certificat")](certificates-identifiers-images/image13-large.png#lightbox)
...
6. Cliquez sur **Download** pour obtenir le certificat, puis double-cliquez dessus pour l’installer dans le **trousseau**. L’utilitaire **Developer Certificate Utility** affiche le certificat comme suit :
    ...
    [![L’utilitaire Developer Certificate Utility](certificates-identifiers-images/image16.png "L’utilitaire Developer Certificate Utility")](certificates-identifiers-images/image16-large.png#lightbox)
7. Il s’affiche également dans le **trousseau** comme suit :

    ![Le certificat dans l’accès au trousseau](certificates-identifiers-images/image17.png "Le certificat dans l’accès au trousseau")
...
4. Choisissez un nom **Common Name** descriptif ; par exemple, utilisez le texte « Application de l’App Store » dans le nom :
    ...
    ![Saisie d’un nom descriptif](certificates-identifiers-images/image20.png "Saisie d’un nom descriptif")
...
10. Cliquez sur **Download** pour obtenir le certificat, puis double-cliquez dessus pour l’installer dans le **trousseau**. L’utilitaire Developer Certificate Utility affiche le certificat comme suit :
    ...
    [![L’utilitaire Developer Certificate Utility](certificates-identifiers-images/image29.png "L’utilitaire Developer Certificate Utility")](certificates-identifiers-images/image29-large.png#lightbox)
11. Les deux nouveaux certificats sont maintenant visibles dans le **trousseau** :

    [![Le certificat dans l’accès au trousseau](certificates-identifiers-images/image30.png "Le certificat dans l’accès au trousseau")](certificates-identifiers-images/image30-large.png#lightbox)
...
5. Choisissez un **nom commun** descriptif. par exemple, utilisez le texte « application d’ID de développeur » dans le nom :

    ![Entrer un nom pour le certificat](certificates-identifiers-images/image33.png "Entrer un nom pour le certificat")
...
9. Choisissez un **nom commun** descriptif. par exemple, utilisez le texte « programme d’installation de l’ID du développeur » dans le nom :

    ![Saisie d’un nom commun](certificates-identifiers-images/image38.png "Saisie d’un nom commun")
10. Un fichier de demande de certificat (extension `.certSigningRequest`) est enregistré localement sur le Mac. Rappelez-vous où il est enregistré (l’emplacement par défaut est le bureau) :
    ...
    [![Téléchargement d’un certificat](certificates-identifiers-images/certif10.png "Téléchargement d’un certificat")](certificates-identifiers-images/certif10-large.png#lightbox)
...
12. Cliquez sur **Download** pour obtenir le certificat, puis double-cliquez dessus pour l’installer dans le **trousseau**. L’utilitaire **Developer Certificate Utility** affiche le certificat comme suit :
    ...
    [![L’utilitaire Developer Certificate Utility](certificates-identifiers-images/certif12.png "L’utilitaire Developer Certificate Utility")](certificates-identifiers-images/certif12-large.png#lightbox)
13. Les éléments suivants sont visibles dans le **trousseau** :

    [![Le certificat dans l’accès au trousseau](certificates-identifiers-images/image43.png "Le certificat dans l’accès au trousseau")](certificates-identifiers-images/image43-large.png#lightbox)
