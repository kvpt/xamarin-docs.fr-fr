...
3. Entrez une **Description**. Définissez ensuite **ID** d’ensemble à **caractères génériques** et entrez un ID au format `com.[DomainName].*` suivant :
