...
![Capture d’écran de la page de liste Xcode dans Mac App Store](installation/images/xcode.png "Xcode sur Mac App Store")

## <a name="getting-started-series"></a>Guides pour bien démarrer

### <a name="setup-and-installation"></a>[Configuration et installation](~/ios/get-started/installation/index.md)
...
## <a name="xamarin-for-objective-c-developers"></a>[Xamarin pour les développeurs Objectif-C](objective-c-developers/index.md)
