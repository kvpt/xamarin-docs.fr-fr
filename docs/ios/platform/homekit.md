...
Vous devez également surveiller les événements et `DidAddHome` `DidRemoveHome` le gestionnaire d’hébergement et mettre à jour l’interface utilisateur de l’application selon vos besoins.
