...
## <a name="in-app-purchasing"></a>[Achats dans l’application](~/ios/platform/in-app-purchasing/index.md)
...
## <a name="ios-gaming-apis"></a>[API de jeu iOS](~/ios/platform/gaming/index.md)
...
## <a name="message-app-integration"></a>[Intégration d’application de message](~/ios/platform/message-app-integration/index.md)
...
## <a name="multitasking-for-ipad"></a>[Multitâche pour iPad](~/ios/platform/multitasking.md)
...
## <a name="social-framework"></a>[Infrastructure sociale](~/ios/platform/social-framework.md)
...
## <a name="speech-recognition"></a>[Reconnaissance vocale](~/ios/platform/speech.md)
...
## <a name="touch-id-and-face-id-with-xamarinios"></a>[Id tactile et ID de visage avec Xamarin. iOS](~/ios/platform/touch-id-face-id.md)
...
## <a name="user-notifications"></a>[Notifications de l’utilisateur](~/ios/platform/user-notifications/index.md)
...
## <a name="embedded-frameworks"></a>[Frameworks incorporés](embedded-frameworks.md)
