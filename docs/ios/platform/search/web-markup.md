...
Pour plus d’informations, consultez la documentation sur le [protocole de carte Twitter](https://developer.twitter.com/en/docs/tweets/optimize-with-cards/overview/abouts-cards) de Twitter.
