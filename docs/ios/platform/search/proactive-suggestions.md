...
Un `INInteraction` est construit à partir de l’intention du message Send ( `INSendMessageIntent` ) et de la réponse ( `INSendMessageIntentResponse` ) que vous venez de créer :
