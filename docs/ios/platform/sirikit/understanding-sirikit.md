...
[![Icône MonkeyChat](understanding-sirikit-images/monkeychat01.png)](understanding-sirikit-images/monkeychat01.png#lightbox)
...
[![Les étapes que Siri suivra](understanding-sirikit-images/monkeychat02.png)](understanding-sirikit-images/monkeychat02.png#lightbox)
...
[![Les trois principales façons dont l’application peut participer à la conversation des utilisateurs avec Siri](understanding-sirikit-images/monkeychat03.png)](understanding-sirikit-images/monkeychat03.png#lightbox)
...
[![Aider Siri à comprendre la parole des utilisateurs](understanding-sirikit-images/monkeychat04.png)](understanding-sirikit-images/monkeychat04.png#lightbox)
...
[![Les résultats présentés à l’utilisateur à la fois oralement et visuellement](understanding-sirikit-images/monkeychat06.png)](understanding-sirikit-images/monkeychat06.png#lightbox)
...
[![Cycle de vie de l’intention](understanding-sirikit-images/monkeychat07.png)](understanding-sirikit-images/monkeychat07.png#lightbox)
...
[![Extension intentions](understanding-sirikit-images/intents01.png)](understanding-sirikit-images/intents01.png#lightbox)
...
En outre, il existe des comportements spécifiques que l’application peut vouloir limiter à l’utilisateur qui est connecté à l’appareil. Dans ce cas, l’application peut demander le comportement **restrict while Locked** . Cette opération s’effectue via un paramètre dans le `Info.plist` fichier.
...
[![Exemple de sortie d’une extension d’interface utilisateur Intent](understanding-sirikit-images/intents02.png)](understanding-sirikit-images/intents02.png#lightbox)

L’extension d’interface utilisateur Intents retourne toujours un `UIViewController` et l’application peut ajouter tout ce qu’elle aime dans le contrôleur d’affichage, par exemple afficher des informations supplémentaires qui vont au-delà de la réponse initiale. L’interface utilisateur Intents peut également mettre à jour l’utilisateur avec l’état d’un événement à long terme, par exemple la durée pendant laquelle une voiture de partage est plus longue pour atteindre son emplacement.
...
Un fichier de vocabulaire comporte plusieurs parties `AppIntentVocabulary.plist` :
