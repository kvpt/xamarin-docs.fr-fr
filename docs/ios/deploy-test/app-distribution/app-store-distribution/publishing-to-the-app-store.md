...
13. Accédez à l’onglet **iOS Bundle Signing** . Si les options ne sont pas modifiables, assurez-vous que l' **approvisionnement manuel** est sélectionné dans le fichier **info. plist** .
