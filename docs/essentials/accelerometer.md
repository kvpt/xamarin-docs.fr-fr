...
description: La classe accéléromètre de vous Xamarin.Essentials permet de surveiller le capteur de l’accéléromètre de l’appareil, qui indique l’accélération de l’appareil dans l’espace tridimensionnel.
