...
Plus de 700 exemples Xamarin sont maintenant disponibles dans le [navigateur d’exemples de code](/samples/browse/?products=xamarin) qui vient d’être lancé. Les pages individuelles, comme cet exemple [Notes](/samples/xamarin/xamarin-forms-samples/getstarted-notes-singlepage/), sont liées à GitHub ou vous permettent de télécharger un fichier ZIP contenant l’exemple.
...
- [Rechargement à chaud XAML](~/xamarin-forms/xaml/hot-reload.md)
