...
La page de codes de pas à pas de **base** de l’exemple [**StepperDemos**](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/userinterface-stepperdemos) montre comment créer un [`Stepper`](xref:Xamarin.Forms.Stepper) et deux [`Label`](xref:Xamarin.Forms.Label) objets dans le code :
...
- [Exemples de démonstrations de pas à pas](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/userinterface-stepperdemos)
