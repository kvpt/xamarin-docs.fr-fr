...
Les exemples de code de ce guide sont tirés de l' [exemple FormsGallery](/samples/xamarin/xamarin-forms-samples/formsgallery).
...
- [Exemple FormsGallery](/samples/xamarin/xamarin-forms-samples/formsgallery)