...
ms.locfileid: "98163502"
---
# <a name="simple-animations-in-no-locxamarinforms"></a>Animations simples dans Xamarin.Forms

[![Télécharger l’exemple](~/media/shared/download.png) Télécharger l’exemple](/samples/xamarin/xamarin-forms-samples/userinterface-animation-basic)
...
- [ `CancelAnimations` ] (XREF : Xamarin.Forms . ViewExtensions. CancelAnimations ( Xamarin.Forms . VisualElement) annule toutes les animations.
...
![Animation rotation](simple-images/rotateto.png)
...
![Animation de rotation relative](simple-images/relrotateto.png)
...
![Mise à l’échelle de l’animation](simple-images/scaleto.png)
...
![Animation de rotation avec ancres](simple-images/rotate-anchors.png)
...
![Animation de translation](simple-images/translateto.png)
...
![Animation de fondu](simple-images/fadeto.png)
...
![Animation composite](simple-images/multiple-rotations.png)

## <a name="canceling-animations"></a>Annulation d’animations

Une application peut annuler une ou plusieurs animations à l’aide d’un appel à [CancelAnimations'] (XREF : Xamarin.Forms . ViewExtensions. CancelAnimations ( Xamarin.Forms . VisualElement)), comme illustré dans l’exemple de code suivant :
