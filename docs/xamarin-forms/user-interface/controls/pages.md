...
| `FlyoutPage` | Un [`FlyoutPage`](xref:Xamarin.Forms.FlyoutPage) gère deux volets d’informations. Affectez [`Flyout`](xref:Xamarin.Forms.FlyoutPage.Flyout) à la propriété une page qui présente généralement une liste ou un menu. Affectez [`Detail`](xref:Xamarin.Forms.FlyoutPage.Detail) à la propriété une page présentant un élément sélectionné à partir de la page de lanceur. La [`IsPresented`](xref:Xamarin.Forms.FlyoutPage.IsPresented) propriété détermine si le menu volant ou la page de détails est visible.<br /><br />Documentation sur les [API](xref:Xamarin.Forms.FlyoutPage)  /  [Guide](~/xamarin-forms/app-fundamentals/navigation/flyoutpage.md)  /  [Exemple](/samples/xamarin/xamarin-forms-samples/navigation-flyoutpage) | [![Exemple FlyoutPage](pages-images/FlyoutPage.png "Exemple FlyoutPage")](pages-images/FlyoutPage-Large.png#lightbox "Exemple FlyoutPage")<br />[Code C# pour cette page](https://github.com/xamarin/xamarin-forms-samples/blob/master/FormsGallery/FormsGallery/FormsGallery/CodeExamples/FlyoutPageDemoPage.cs)  /  [Page XAML](https://github.com/xamarin/xamarin-forms-samples/blob/master/FormsGallery/FormsGallery/FormsGallery/XamlExamples/FlyoutPageDemoPage.xaml) avec [code-behind](https://github.com/xamarin/xamarin-forms-samples/blob/master/FormsGallery/FormsGallery/FormsGallery/XamlExamples/FlyoutPageDemoPage.xaml.cs) |
