...
![Diagramme montre le diagramme précédent annoté avec une ligne rouge qui affiche l’arc tangente en surbrillance entre les deux lignes.](arcs-images/tangentarchighlight.png)
