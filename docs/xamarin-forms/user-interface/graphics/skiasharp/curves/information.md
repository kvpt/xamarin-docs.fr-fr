...
description: Cet article explique comment obtenir des informations sur les chemins d’accès SkiaSharp et comment énumérer le contenu, et illustre cela avec un exemple de code.
ms.prod: xamarin
