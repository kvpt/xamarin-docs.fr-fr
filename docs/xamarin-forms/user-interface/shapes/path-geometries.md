---
title: 'Xamarin.FormsFormes : géométries de tracés'
description: Xamarin.FormsLes classes Geometry de tracés vous permettent de décrire la géométrie d’une forme 2D.
ms.prod: xamarin
...
ms.locfileid: "85101853"
---
# <a name="xamarinforms-shapes-path-geometries"></a>Xamarin.FormsFormes : géométries de tracés
