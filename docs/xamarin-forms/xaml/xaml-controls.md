...
| <h3>Carte</h3>Affiche une carte.<p align="center">![Capture d’écran d’une carte](xaml-controls-images/Map.png "Carte")</p>[Guide](~/xamarin-forms/user-interface/map.md) d'  /  d' [API](xref:Xamarin.Forms.Maps.Map) | <p valign="center"><pre>&lt;maps:Map ItemsSource="{Binding Locations}" /&gt;</pre></p> |
...
| <h3>SearchBar</h3>Affiche une barre de recherche pour effectuer une recherche.<p align="center">![Capture d’écran d’un SearchBar](xaml-controls-images/SearchBar.png "SearchBar")</p>[Guide](~/xamarin-forms/user-interface/searchbar.md) d'  /  d' [API](xref:Xamarin.Forms.SearchBar) | <p valign="center"><pre>&lt;SearchBar Placeholder="Xamarin.Forms Property"<br />           SearchButtonPressed="OnSearchBarButtonPressed" /&gt;</pre></p> |
|     |     |
