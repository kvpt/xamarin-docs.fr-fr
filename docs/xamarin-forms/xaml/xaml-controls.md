...
| <h3>Courbes</h3>Affichez une ligne.<p align="center">![Capture d’écran d’une ligne](xaml-controls-images/Line.png "Courbes")</p>[API](xref:Xamarin.Forms.Shapes.Line)  /  [Guide](~/xamarin-forms/user-interface/shapes/line.md) | <p valign="center"><pre>&lt;Line X1="40"<br />      Y1="0"<br />      X2="0"<br />      Y2="120"<br />      Stroke="Red"<br />      HorizontalOptions="Center" /&gt;</pre></p> |
