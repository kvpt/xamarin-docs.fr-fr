...
Pour plus d’informations sur le service de jeton de cognitive services, consultez [API de jeton d’authentification](https://docs.microsofttranslator.com/oauth-token.html).
...
Pour plus d’informations sur les API REST de traduction de texte, consultez [API Microsoft Translator Text](https://docs.microsofttranslator.com/text-translate.html).
...
- [API Microsoft Translator Text](https://docs.microsofttranslator.com/text-translate.html).
