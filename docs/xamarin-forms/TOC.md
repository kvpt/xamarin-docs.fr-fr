...
## [Prise en main](~/get-started/index.yml)
### [Qu’est-ce que Xamarin.Forms](~/get-started/what-is-xamarin-forms.md)
### [Configuration requise](~/get-started/requirements.md)
...
#### [action](app-fundamentals/shell/search.md)
...
### Mises en forme
#### [Vue d'ensemble](user-interface/layouts/index.yml)
...
#### [Data Sources](user-interface/listview/data-and-databinding.md) (Sources de données)
...
### [Dépannage](~/essentials/troubleshooting.md?context=xamarin/xamarin-forms)
...
#### [Stockage Azure](data-cloud/azure-services/azure-storage.md)
