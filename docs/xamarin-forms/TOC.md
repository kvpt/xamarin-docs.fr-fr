...
#### [Données](user-interface/carouselview/populate-data.md)
...
#### [Mode de transition par balayage SwipeView](platform/android/swipeview-swipetransitionmode.md)
...
#### [Mode de transition par balayage SwipeView](platform/ios/swipeview-swipetransitionmode.md)
...
### [Lien source](internals/sourcelink.md)
