...
1. [Créer](#Creating_the_Custom_Map) une Xamarin.Forms carte personnalisée.
1. [Utilise](#Consuming_the_Custom_Map) le mappage personnalisé à partir de Xamarin.Forms .
