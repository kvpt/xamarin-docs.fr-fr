...
- [Java. util. List\<E >](https://developer.android.com/reference/java/util/List.html) est mappé au type de système [\<IList t >](xref:System.Collections.Generic.IList`1), classe d’assistance [Android. Runtime\<. JavaList T >](xref:Android.Runtime.JavaList`1).
