...
ms.locfileid: "86996888"
---
# <a name="xamarinandroid-platform-features"></a>Fonctionnalités de la plateforme Xamarin. Android
...
Cet article présente les nouvelles fonctionnalités du secteur Android, explique comment préparer Xamarin. Android pour le développement en secteurs Android, et fournit un exemple d’application qui illustre comment utiliser le nouveau secteur Android afficher le découpage et les fonctionnalités de notification dans les applications Xamarin. Android.
...
Cet article présente le fichier AndroidManifest.xml et la façon dont il peut être utilisé pour contrôler les fonctionnalités et décrire les exigences d’une application mono pour Android.
...
Ce guide explique comment créer des liaisons C# vers du code Kotlin, ce qui permet de consommer des bibliothèques natives dans une application Xamarin. Android.
