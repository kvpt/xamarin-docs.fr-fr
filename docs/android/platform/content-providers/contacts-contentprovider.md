...
Reportez-vous aux [ListViews et aux adaptateurs](~/android/user-interface/layouts/list-view/index.md) pour `SimpleCursorAdapter`plus d’informations sur l’implémentation de.
