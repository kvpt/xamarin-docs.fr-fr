...
[![Capture d’écran Google Play](images/google-play-app.png)](images/google-play-app.png#lightbox)
...
- [Questions fréquentes (FAQ) sur le distribution des applications mobiles Amazon](https://developer.amazon.com/help/faq.html)
