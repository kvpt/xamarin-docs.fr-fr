...
[![Création d’un nouveau certificat](images/vs/04-key-store-example-vs-sml.png)](images/vs/04-key-store-example-vs.png#lightbox)
...
[![Boîte de dialogue Créer un autre certificat](images/xs/03-create-new-certificate-sml.png)](images/xs/03-create-new-certificate.png#lightbox)
...
[![Identité de signature - Exemple](images/vs/05-save-as-vs-sml.png)](images/vs/05-save-as-vs.png#lightbox)
