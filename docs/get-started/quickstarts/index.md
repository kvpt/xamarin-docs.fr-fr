...
## <a name="create-a-single-page-xamarinforms-applicationsingle-pagemd"></a>[Créer une application Xamarin.Forms monopage](single-page.md)
...
## <a name="perform-navigation-in-a-multi-page-xamarinforms-applicationmulti-pagemd"></a>[Naviguer dans une application Xamarin.Forms multipage](multi-page.md)
...
## <a name="style-a-cross-platform-xamarinforms-applicationstylingmd"></a>[Appliquer des styles dans une application Xamarin.Forms multiplateforme](styling.md)

Apprenez à appliquer des styles XAML sur une application Xamarin.Forms multiplateforme.

## <a name="quickstart-deep-divedeepdivemd"></a>[Démarrage rapide en immersion](deepdive.md)
